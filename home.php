...
if(isset($_POST['aboutMe'])){
	$displayAboutMe='none';
	$displayAboutMeEdit='block';
}else{
	$displayAboutMe='block';
	$displayAboutMeEdit='none';
}
if(isset($_POST['lookingFor'])){
	$displayLookingFor='none';
	$displayLookingForEdit='block';
}else{
	$displayLookingFor='block';
	$displayLookingForEdit='none';
}
if(isset($_POST['personalInfo'])){
	$displayPersonalInfo='none';
	$displayPersonalInfoEdit='block';
}else{
	$displayPersonalInfo ='block';
	$displayPersonalInfoEdit='none';
}
...
<head>
	...
	<link rel="stylesheet" href="tel-input/build/css/intlTelInput.css" >
	
	<?php require("include/script.php"); ?>
	<style>
		#basic-info-view li{list-style: none;}
	</style>
</head>
...
<body class="<?php echo $CustomizeTheme; ?>">
	<div class="main-body">
		...
		<div class="clearfix">
			...
			<!-----------------GET ME HERE SLIDER--------------------------------------->
			<?php 
			include('include/header-get-me-here.php'); 			
			?>
			<!-----------------GET ME HERE SLIDER END----------------------------------->
			
			<div class="container">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main_sec_pad_left_0">
					...
					<!---------------------------------------------------------->
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 col_sm_9_small">
							...
							<!--------PROMOTION PANEL--------------------->
							<?php include('include/promotion-panel.php');?>
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 mid_sec_01">
									<div class="row">
										...
										<!--##########################BASIC INFORMATION##################-->
											<div class="pull-left" id="basic-info-view">
												...
												<?php echo $userProfileObj->getProfilePromoteDate($user_id);?>
											</div>
											<!-----------------EDIT VIEW------------------------------------>
												...
												<form class="pro_name" method="post">
													...
													<ul class="pro_edit_btn">
														<li>
															...
															<div class="cancel">or  <a href="javascript:void(0);" id="cancel-basic-info">Cancel</a></div>
														</li>
											...
											<div class="pull-left margin-t10">
												<div class="intest_box">
													<a href="javascript:void(0)" style="cursor:default;">
														<span id="getCount"><?php echo $userInterestCount;?></span>
														<p>YOUR INTEREST<?php echo ($userInterestCount>1)?"S":""; ?></p>
													</a>
												</div>
												<div class="intest_box">
													<a href="javascript:void(0)" style="cursor:default;">
														<span><?php echo $friendCount;?></span>
														<p>YOUR FRIENDS<?php echo ($friendCount>1)?"S":""; ?></p>
													</a>
												</div>
										...
										<!--##########################I M HERE TO##################-->
											<div class="pull-left" id="here-to-view">
												...
												<p id="here-to-content"><?php echo $userProfileObj->getHereToName($userResult['here_to']);?></p>
										...
										<!--##########################LOCATION##################-->
											<div class="pull-left" id="location-view">
												...
												<div class="location_map margin-t10">
													<div id="googleMap" style="width:100%;height:80px;"></div>
												</div>
											</div>
											<div class="pull-left" id="location-edit" style="display:none;">
												...
												<form method="post">
													...
													<div id="googleMap1" style="width:100%;height:80px;"></div>
													<ul class="pro_edit_btn">
														<li>
											...
											<div class="pull-left" id="interest-edit" style="display:none;">
												...
												<div class="btn-group interests" role="group">
													<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="$('#interest-manually').show()">
														<div class="pull-left">Choose interests manually <i class="fa fa-caret-down"></i> </div>
													</button>
										...
										<!--#########################FRIENDS##################-->
											<div class="pull-left">
												<div class="pro_ttl margin-b5">
													<span>Friends</span> 
													<span class="badge margin-r5i"><?php echo $friendCount;?></span> 
													<a href="friends.php" id="edit-btn2" class="edit bg">
														<i class="fa fa-pencil"></i>
														<span class="pull-right">edit</span>
													</a>
												</div>
											...
											<div class="divider-line clearfix"></div>
											<!--#########################ABOUT ME########################-->
											<div class="pull-left" id="about-me-view" style="display:<?php echo $displayAboutMe;?>">
												<div class="pro_ttl">
													<span>About me</span> 
											...
											<div class="pull-left" id="about-me-edit" style="display:<?php echo $displayAboutMeEdit;?>"> 
												<div class="pro_ttl">
													<span>About me</span> 
												</div>
												<form method="post">
											...
											<div class="divider-line clearfix"></div>
											<!--########################LOOKING FOR######################-->
											<div class="pull-left" id="looking-for-view" style="display:<?php echo $displayLookingFor;?>">
												<div class="pro_ttl">
											...
											<div class="pull-left" id="looking-for-edit" style="display:<?php echo $displayLookingForEdit;?>">
												<div class="pro_ttl">
													<span>Looking for</span> 
												</div>
												<form method="post">
											...
											<div class="pull-left" id="personal-info-view" style="display:<?php echo $displayPersonalInfo;?>">
												<div class="pro_ttl">
														...
														<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															<ul>
																...
																<li>	
																	...
																	<div><?php echo $userProfileObj->getIncomeName($userResult['income']);?></div>
																</li>
																<li>	
											...
											<div class="pull-left" id="personal-info-edit" style="display:<?php echo $displayPersonalInfoEdit;?>">
												<div class="pro_ttl">
													<span class="pull-left">Personal Info</span>
													<div class="pull-right">
														<div class="word_count"><span id="profPer"><?php echo $profilePercentage;?></span>% Complete 
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<ul>
																<li>
																	...
																	<div>
																		<div class="form-group">
																			<select class="slec_m" id="lang" multiple="multiple">
																			<?php 
																			if(count($userLanguageArray) > 0){
																				foreach($languageArray as $languages){
																					...
																					if($selected){
																						...
																						echo "<option class='p_location language' value='".$languages['language_id']."' disabled /><span>".$languages['language']."</span></option>";
																					}
																				}
																			}
																			else{
																				foreach($languageArray as $languages){
																					...
																					echo "<option class='p_location language' value='".$languages['language_id']."' /><span>".$languages['language']."</span></option>";
																				}
																			}
																			?>
																			</select>
...
print_r($countPhoto);*/
	if($countPhoto){
		...
		foreach($gallery_array as $gallery){
			...
			/*echo $is_profileImage;*/
			include('slider/gallery.php');
			$iCount++;
		}
	}
?>
...
$(document).ready(function(){
	...
	var displayAboutMeEdit='<?php echo $displayAboutMeEdit;?>';
	var displayLookingForEdit='<?php echo $displayLookingForEdit;?>';
	var displayPersonalInfoEdit='<?php echo $displayPersonalInfoEdit;?>';
	if(displayAboutMeEdit == 'block'){
		$('#about-me-edit').animatescroll();
	}
	if(displayLookingForEdit == 'block'){
		$('#looking-for-edit').animatescroll();
	}
	if(displayPersonalInfoEdit == 'block'){
		$('#personal-info-edit').animatescroll();
	}
		...
		$.ajax({
			...
			success:function(result){
				...
				if(result == 1){
					...
					$('#error_message').html('Address changed succesfully.');
					$('#alert_modal').modal('show');
				}else if(result == 2){
					$('#error_message_header').html('Email address already registered');
...
function initMap(lat , lon)
{
	...
	autocomplete1.addListener('place_changed', function() {
		...
		$('#locationlat').val(place1.geometry.location.lat());
		$('#locationlon').val(place1.geometry.location.lng());
	});
}
    ...
    $(function () {
        $('#lang').multiselect({
			...
			onChange: function(option, checked) {
                ...
                var selectedOptions = $('#lang option:selected');
 
                if (selectedOptions.length >= 5) {
                    // Disable all other checkboxes.
                    var nonSelectedOptions = $('#lang option').filter(function() {
                        return !$(this).is(':selected');
                    });
 
                    var dropdown = $('#lang').siblings('.multiselect-container');
		...
		$('.language').live('click' , function(){
			if($(this).hasClass('disabled')){
				$('#error_message_header').html('Alert');
				$('#error_message').html('Please select maximum 5 languages.');
				$('#alert_modal').modal('show');
			}
		});
		
		
		//Set placeholder to be empty on click
		$('input').focus(function(){
			$(this).removeAttr('placeholder');
		});
    });
    </script>
<?php #Country Codes and Flags ?>	

<?php
ini_set("display_errors",1);
$rejected_array=$userProfileObj->getrejectedphotos($user_id);
//print_r($rejected_array);
?>
		<!-- Modal -->
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<?php
						if(count($rejected_array)==1)
						{
							echo '<h4 class="modal-title">Your recent image has been moderated and removed. </h4>';
					
						 }
						else
						{
							echo '<h4 class="modal-title">Your recent images have been moderated and removed. </h4>';
							} ?>
					</div>
					...
					<div class="modal-body">
						...
						<style type="text/css">
							.slide-title{ color:#fff; text-align: center; padding: 6px 0; }
						</style>
						<ul class="myphotosfix" id="bxslider-slide" style="width: 815%; position: relative; transition-duration: 0s; transform: translate3d(-1130px, 0px, 0px);">
							<?php
							foreach($rejected_array as $key=> $item)
							{ //print_r($rejected_array);
								//echo $rejected_array[$key]['photo'];
								$photo_id=$rejected_array[$key]['photo_id'];
								$sql=mysql_query("select * from sr_photo_report where photo_id=$photo_id");
								$reason_array=mysql_fetch_array($sql);

							?>
								<li style="float: left; list-style: none; position: relative; width: 565px;" class="bx-clone">
									<!--<div class="slide-title">Reason-<?php //echo $reason_array['reason'];	 ?></div> -->
									<img src="<?php echo $userProfileObj->getPhotoPath($rejected_array[$key]['photo']);?>" id="sliderImage-152-3">
								</li>
							<!--<div class="item"><img src="<?php /*echo $userProfileObj->getPhotoPath($rejected_array[$key]['photo']);*/?>"></div>-->
							<?php
								//echo "UPDATE `sr_user_photo` SET `is_usernotified` = '1' WHERE `sr_user_photo`.`photo_id` = ".$rejected_array[$key]['photo_id'];
								$update_query=mysql_query("UPDATE `sr_user_photo` SET `is_usernotified` = '1' WHERE `sr_user_photo`.`photo_id` = ".$rejected_array[$key]['photo_id']);
							}
							?>
						</ul>
					</div>
		...
		if(!empty($rejected_array)) {
			...
			<?php
			/*foreach ($rejected_array as $item) {
		...
		<script>
		$(document).ready(function() {
	$('#bxslider-slide').bxSlider({pager:false});
});
...
<script src="tel-input/build/js/intlTelInput.js"></script>
<script type="text/javascript">
...
<script>
	...
	/* $(".language").on('click', function () {
		alert('dwasg');
		alert($("#lang option:selected").length);
		if ($("#lang option:selected").length > 5) {
			$('#error_message_header').html('Alert');
			$('#error_message').html('select Max 5 language at a time');
			$('#alert_modal').modal('show');
