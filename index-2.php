			...
			<div class="contain">
				<div class="mainin">
					<div class="left margin-t100 align-c sign-up-index">
						<h2 class="margin-b80">Whether you're serious about matrimony, Looking for new friends and simply want to explore, everyone is welcome to Startrishta</h2>
						...
						<div class="col-lg-10 col-sm-offset-1">
							...
							<div class="col-sm-4 col-xs-12 pull-right lato-family clearfix ">
								<div class="form-group">
							...
							<div class="col-sm-12">
								<p class="pull-right lato-family">By joining, you are agreeing to our <a href="">Terms of service</a> and <a href="#">Privacy Policy.</a> </p>
