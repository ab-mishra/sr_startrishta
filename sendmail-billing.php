...
include("classes/mailerClass.php");
	...
	function sendMailAdmin($contact_message,$contact_type,$date)
	{	
		$mail=new PHPmailer;
		$mail->IsHTML(true);
		...
		<tr>
		<td width='35%' style='padding: 3px 3px 3px 3px;'>Contact Type:</td><td style='padding: 3px 3px 3px 3px;'>Billing questions</td>
		</tr>
		<tr>
		...
		<tr>
		<td width='35%' style='padding: 3px 3px 3px 3px;'>Contact Type:</td><td style='padding: 3px 3px 3px 3px;'>".$contact_type."</td>
		</tr>
		<tr>
