...
<a class='login' href='javascript:void(0);'  style="float:left;"><img alt='Signin in with Google' src='images/google.png' /></a>
 ...
 <?php  } else { 
    if(isset($_SESSION['User'])){  
	 ...
	 ?>
      <img src="https://graph.facebook.com/<?php echo $_SESSION['User']['id']; ?>/picture" width="50"/><div><pre><?php echo $_SESSION['User']['name'];  print_r($_SESSION['User']); ?></pre></div>
...
<?php }
  ...
  ?>
     ...
     <div><pre><?php echo $_SESSION['User']['email'];  ?></pre></div>
