...
if(isset($_GET['q'])){
	$query=$_GET['q'];
	$sqlFaq=mysql_query("select * from sr_faq where status='1' AND faq_type_id=1 AND question LIKE '%".$query."%'");
}else{
	$query='';
	$sqlFaq=mysql_query("select * from sr_faq where status='1' AND faq_type_id=1");
}
										...
										if(mysql_num_rows($sqlFaq)){
											...
											<div class="col-lg-12">
												<div class="faq_bg margin-t10">
													...
													Alternatively choose a topic from the navigation bar or you can contact us <br />
