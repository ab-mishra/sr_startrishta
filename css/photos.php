								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="row">
										<div class="profile_view margin-b20">
											<div class="pull-left">
												<span class="pro_name_m"><?php echo $userResult['user_name'];?>,</span> <span class="pro_age_m"><?php echo (2015 - date('Y' ,strtotime($userResult['dob']))) ;?></span> 
													...
													<ul>
														...
														foreach($gallery_array as $gallery){
															...
															<li class="pointer">
																...
																<?php  
																$photoPath = $userProfileObj->getPhotoPath($photo);
														//if($photoPath != 0){
																?>	
																...
																<span class="my-photos"> 
																	<a data-toggle="modal" id="editimg-<?php echo $photo_id.'-'.$iCount;?>" data-target="#imageEdit" href="javascript:void(0);"><i class="fa fa-pencil pointer"></i></a>


															<!-- <a href="javascript:void(0);" class="rotateLeft" id="rotateLeft-<?php //echo $photo_id.'-'.$iCount;?>"><i class="fa fa-undo pointer"></i></a>
															<a href="javascript:void(0);" class="rotateRight" id="rotateRight-<?php //echo $photo_id.'-'.$iCount;?>"><i class="fa fa-repeat pointer"></i></a> -->
										...
										<div class="photos-my-photos">
											<ul>
												...
												foreach($friendGalleryArray as $friendGallery){
													...
													<li class="pointer">
														...
														<?php  
														$groupPhotoPath = $userProfileObj->getPhotoPath($groupPhoto);
														//if($photoPath != 0){
														?>	
											...
											<div class="pull-left">
												...
												<div class="photos-my-photos">
													<ul>
														...
														foreach($privateGalleryArray as $privateGallery){
															...
															$privatePhotoPath = $userProfileObj->getPhotoPath($privatePhoto);
															if($privatePhotoPath != ''){
																?>
																<li class="pointer">
																	<li class="pointer">
												...
												<ul class="add-more-photos">
													...
													<li> | </li>
													<li class="pointer makeAlbumPublic" data-id="makeAlbumPublic"><a class="color-green">Make Collection Public</a></li>	
												</ul>
											</div>
											<!-- -->
										</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="imgRotateBox" id="imgRotateBox">
							<img id="ro-img-src" src="<?php //echo $photoPath11 = $userProfileObj->getPhotoPath($gallery3['photo']); ?>" alt="start rishta profile image">
						</div>
					</div>

					<div class="modal-footer">
						<div class="sliderImgRotate">
							<button onclick="rotateRight()"><i class="fa fa-repeat"></i></button>
							<button onclick="rotateLeft()"><i class="fa fa-undo"></i></button>
						</div>
