...
<head>
    ...
    <style>
        ...
        .promote_list li{position: relative;}
        .promote_list li span{position: absolute; right: 6px; top:6px;}
    </style>
        ...
        <div id="content" class="">
            <div class="container-fluid">
                <div class=" drag-drop dash-main">
                    <div class="row-10">
                        <h5>EP User List <a href="ep-user-list.php" class="pull-right back-btn"><span class="fa fa-arrow-left"></span>Back</a></h5>
                        <div class="col-lg-5">
                            <div class="">
                                <form>
                    ...
                    <div class="col-lg-12">
                        <div class="pane equal">
                            <div class="table-responsive">
                                ...
                                <div id="create_ep_err" ></div>
                                <table class="table table-responsive" style="width:100%;">
                                    <tr>
                                        <th class="th1" style="width: 25%;">Promote</th>
                                        <th class="th1" style="width: 25%;">Visit</th>
                                        <th class="th1" style="width: 25%;">Message</th>
                                        <th class="th1" style="width: 25%;">Rate Photos</th>
                                    </tr>
                                    <tr>
                                        <td class="promote-wap">
                                            <form name="promote-form" id="promote-form">
                                                <input type="hidden" value="<?php echo $_GET['uid'] ?>" name="uid" />
                                            <ul class="promote_list">
											<li>Add 100 Priority Displays in Kismat Connection<span class="int-span"><input type="checkbox" value="priority" id="priority" /> </span></li>
											<li>Get To Top of People Search<span class="int-span"><input type="checkbox" value="top-search" id="top-search" /> </span></li>
											<li>Add Profile Photo to Fame Reel<span class="int-span"><input type="checkbox" value="fame-reel" id="fame-reel" /> </span></li>
											<li>Show I'm Ready to chat in Messages<span class="int-span"><input type="checkbox" value="ready-to-chat" id="ready-to-chat" /> </span></li>
											<li>Increase Reputation to Very Hot<span class="int-span"><input type="checkbox" value="reputation" id="reputation" /> </span></li>
											<li>Go VIP<span class="int-span"><input type="checkbox" value="govip" id="govip" /> </span></li>
											<li>
												<button type="button" id="promote-selected-btn" class="btn btn-block btn-default btn-green">Promote Selected</button>
											</li>
											<li>
												<button type="button" id="promote-all-btn" class="btn btn-block btn-default btn-red">Promote All</button>
											</li>
                                            </ul>
                                            </form>
                                        </td>
                                        <td class="promote-wap">
                                            <form name="visit-form" id="visit-form">
                                                <div class="form-group select-wap">
                                                <select class="selectpicker" name="visit-select" id="search_options">
                                                    <option value="male">Male Only</option>
                                                    <option value="female">Female Only</option>
                            ...
                            <input type="hidden" value="<?php echo $_GET['uid'] ?>" name="uid" />
                                            ...
                                            <ul class="promote_list">
                                                ...
                                                <li>Profile Visitor Pages<span class="int-span"><input type="checkbox" value="visitor" name="visitor" id="visitor" /> </span></li>
                                                <li>Liked Me Pages<span class="int-span"><input type="checkbox" value="liked" name="liked" id="liked" /> </span></li>
                                                <li>Favorite Pages<span class="int-span"><input type="checkbox" value="favorite" name="favorite" id="favorite" /> </span></li>
                                                <li>
                                                    <button type="button" id="visit-submit" class="btn btn-block btn-default btn-green">Visit Selected</button>
                                                </li>
                                                <li>
                                                    <button type="button" id="visit-all" class="btn btn-block btn-default btn-red">Visit All</button>
                                                </li></ul>
                                            </form>
                                        </td>
                                        <td class="promote-wap">
                                            <form name="message-form" id="message-form">
                                                <input type="hidden" value="<?php echo $_GET['uid'] ?>" name="uid" />
                                            <div class="form-group select-wap">
                                                <select class="selectpicker"  id="search_options" name="message-select">
                                                    <option value="male">Male Only</option>
                                                    <option value="female">Female Only</option>
                                                    <option value="all">All</option>
                                                </select>
                                            ...
                                            <ul class="promote_list">
                                                ...
                                                <li>Send a stock greeting <span class="int-span"><input type="checkbox" id="stock" value="stock" /> </span></li>
                                                <li>Send a waiting to talk notification<span class="int-span"><input type="checkbox" value="wait-to-talk" id="wait-to-talk" /> </span></li>
                                                <li>
                                                    <button type="button" class="btn btn-block btn-default btn-green" id="msg-select-btn">Message Selected</button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-block btn-default btn-red" id="msg-all-btn">Message All</button>
                                                </li></ul>
                                        </form>
                                        </td>
                                        <td>Rate User Photos <a href="javacript:void(0)" onclick='window.open("get_ep_login.php?uid=<?php echo $_GET['uid']; ?>&action=rate-photos","_blank")'>Rate Now </a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
