									...
									<div class="p-info-form">
										...
										<div class="form-group search">
											<div class="col-md-9 col-sm-8">
												...
												<input id="locationlat_1" type="hidden" value="" />
												<input id="locationlon_1" type="hidden" value="" />
												<input id="locationlat_2" type="hidden" value="" />
												<input id="locationlon_2" type="hidden" value="" />
												<input id="locationlat_3" type="hidden" value="" />
												<input id="locationlon_3" type="hidden" value="" />
												<input id="locationlat_4" type="hidden" value="" />
												<input id="locationlon_4" type="hidden" value="" />
												<input id="locationlat_5" type="hidden" value="" />
												<input id="locationlon_5" type="hidden" value="" />
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCG8r0vfpOTrfshIe00Sp1YvUjFOteMICE&libraries=places&callback=initMap" async defer></script>
