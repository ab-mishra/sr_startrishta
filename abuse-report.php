												...
												if( count($userReportedArray) )
												{
													...
													foreach( $userReportedArray as $userReported )
													{
														...
														<tr id="userReportedDiv-<?php echo $userReported['user_report_id'];?>">
															...
															<td>
																<a href="power-search.php?id=<?php echo $userReported['user_id'];?>"><?php echo $userReported['user_name'];?></a>
															</td>
															<td>
															...
															<td>
																...
																if($userReported['reason'] == 'Other'){
																	echo wordwrap($userReported['description'],25, "<br>", true);
																}else{
																	echo wordwrap($userReported['reason'],25, "<br>", true);
																}?>
															</td>
															<td>
