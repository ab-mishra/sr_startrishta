...
$userTimestampArray=$adminObj->getUserTimestamp($userId);
...
<head>
        ...
        <title>Startrishta | User Timestamp</title>
			...
			<div id="content" class="">
			    <div class="container-fluid">
					<div class=" drag-drop dash-main">
						<div class="row-10">
					   		<h5 class="no-space"> User's  Timestamp </h5>
					   	<p><a href="power-search.php" class="cgreen"> <i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to Power Search</a></p>
							...
							<div class="col-sm-6">
									...
									<tbody>
									<?php foreach($userTimestampArray as $userTimestamp){?>
									    <tr>
											<td><?php echo date('d/m/Y h:i', strtotime($userTimestamp['login_time']));?></td>
											<td><?php echo date('d/m/Y h:i', strtotime($userTimestamp['logout_time']));?></td>
											<td>
											<?php 
												$diff = (strtotime($userTimestamp['logout_time']) - strtotime($userTimestamp['login_time']))/60;
												echo (int)$diff;
											?>
											</td>
									    </tr>
