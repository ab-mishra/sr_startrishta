            ...
            <div class="container-fluid">
                <div class="drag-drop dash-main">
                    <div class="row-10">
                        ...
                        <h5 class="no-space">Edit Entertainment Profile  <a href="ep-user-list.php" class="pull-right back-btn"><span class="fa fa-arrow-left"></span>Back</a></h5>
                                ...
                                <div class="profile-dash admin-form-e clearfix">
                                    ...
                                    <div class="p-info-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {?>
                                            <img id="previewing" src="<?php echo SITEURL;?>upload/photo/<?php echo $getProfileInfo['photo']; ?>" width="150px" height="150px"></div>
                                            <?php } ?>
