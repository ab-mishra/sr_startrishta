			    ...
			    <div class="container-fluid">
					<div class=" drag-drop dash-main">
						<div class="row-10">
							...
							<?php if(strstr($_SERVER['HTTP_REFERER'], 'user-list')){
								$page = 'User List';
							}
							else{
								$page = 'Power Search';
							}?>
					   	<p><a href="<?php echo $_SERVER['HTTP_REFERER'];?>" class="cgreen"> <i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to <?php echo $page; ?></a></p>
								...
								<div class="profile-dash clearfix">
									<ul class="middle-dash clearfix">
                                   	<li class="clearfix">
                                    	<ul class="top-dash-profile clearfix">
                                           ...
                                           <li>
												<div class="form-group profile-date">
													...
													<input type="text" readonly = "readonly" class="form-control" placeholder="mm/dd/yyyy" value="<?php echo date('d/m/Y', strtotime($userResult['dob']));?>">
												    </div>
												</div>
                                            </li>
	                                        ...
	                                        <li>
	                                            ...
	                                            <div class="dropdown">
												  <button class="btn drop-box dropdown-toggle cur" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
												    <?php if($userResult['gender'] == 1){ ?>
														Male
													<?php } else { ?>
														Female
													<?php } ?>
											...
											<ul class="slider-map">
												<li>
													...
													<?php foreach($photosArray as $photos){?>
														<div class="item"><img src="<?php echo $adminObj->getThumbProfileImage($photos['photo']);?>" class="img-responsive" /></div>
													<?php } ?>
													</div>
												</li>
												<!--<li>
										...
										<li class="">
											<h6> Looking for </h6>
											<p><?php echo $userResult['looking_for'];?></p>
										</li>
										<?php
			    			...
			    			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
								<ul class="psickers clearfix">
							   		...
							   		<ul class="pgift clearfix">
							   			...
							   			?>
							   			<li>
							   				<img src="<?php echo SITEURL;?>images/<?php echo $userGift['gift'];?>" class="img-responsive">
							   			</li>
								   		<li>
