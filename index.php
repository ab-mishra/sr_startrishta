...
require_once 'fb-login/Facebook/autoload.php';
	...
	$permissions = ['email','user_photos','public_profile','user_friends']; // optional
	$signUpUrl = $helper->getLoginUrl(SITEURL.'fb-login/callback.php?accesstype='.base64_encode("signup"), $permissions);
	$importUrl = $helper->getLoginUrl(SITEURL.'fb-login/import.php?accesstype='.base64_encode("import"), $permissions);
	define("FBSIGNUP",$signUpUrl);
	define("FBIMPORT",$importUrl);
?>
...
<body>
			...
			<div class="contain">
				<div class="mainin">
					<div class="left margin-t100 align-c sign-up-index">
						<h2 class="margin-b80">Join The Most Vibrant Community Of Singles</h2>
						
						<div class="col-lg-10 col-sm-offset-1">
							<h4 class="margin-b10"> With thousands of people joining everyday, it’s easy to meet new people!</h4>
							<ul class="list-signup lato-family clearfix center-block text-center">
								<li>
									<div class="form-group ">
									  	<input type="text" class="form-control" id="signUpEmailId" placeholder="E-mail address">
									  	<div class="ab-input">
								...
								<li>
									<div class="form-group">
									 	<button type="button" id="signUpButton" class="btn  btn-block f-bold">Sign Up for Free</button>
									</div>
								</li>
							</ul>
							<!--<div class="col-sm-4 col-xs-6 width-100 pull-right lato-family clearfix ">
								<div class="form-group">
								 	<button type="button" class="btn face-btn  btn-block f-bold fblogin">Sign Up with Facebook</button>
							...
							<div class="col-sm-4 col-xs-6 width-100 pull-right lato-family clearfix ">
								...
								<div class="form-group">
								 	<button type="button" class="btn face-btn  btn-block f-bold fbloginapp">
								 		<a href="javascript:void(0);" id="fbloginapp" style="color:#fff;">Sign Up with Facebook</a></button>
								 	<div class="ab-facebook">
									  	<i class="fa fa-facebook" aria-hidden="true"></i>
									</div>
								</div>
							...
							<div class="col-sm-12">
								<p class="pull-right lato-family">By joining, you are agreeing to our <a href="terms.php">Terms of service</a> and <a href="privacy-policy.php">Privacy Policy.</a> </p>
					...
					<div class="middle left margin-t300 align-c custom-index">
	...
	<section class="bgcolor padding-t55 lato-family padding-b65 clearfix section-resp">
		<div class="contain resp_contain">
			<div class="full margin-b10" id="go-to-top">
				<div class="lato-family align-c font50 clearfix">Why you'll love Startrishta</div>
			</div>
			<div class="fourth">
				<div class="icons">
					<img src="images/twitter-red.png" alt="Chatting Sites in India"/>
				</div>
			...
			<div class="fourth">
				<div class="icons">
					<img src="images/icon2.png" alt="Meet People Online" />
				</div>
			...
			<div class="fourth">
				<div class="icons">
					<img src="images/icon3.png" alt="Friend Chat Sites in India"/>
				</div>
			...
			<div class="fourth">
				<div class="icons">
					<img src="images/icon4.png" alt="Meet New People Online"/>
				</div>
...
$(document).ready(function(){
	...
	if($("#fbChk").html() == "denied"){
		$('#error_message_header').html('Alert');
		$('#error_message').html('Your account has been deleted or suspended. Please contact for further support.');
		$('#alert_modal').modal('show');
	}
	
	if($("#fbChk").html() == "deleted"){
		$('#error_message_header').html('Alert');
		$('#error_message').html('Your account has been deleted by Admin. Please contact for further support.');
		$('#alert_modal').modal('show');
	}

	if($("#fbChk").html() == "fb_error"){
		$('#error_message_header').html('Alert');
		$('#error_message').html('Facebook Login error.');
		$('#alert_modal').modal('show');
	}
