...
if(isset($_GET['q'])){
	$query=$_GET['q'];
	$sqlFaq=mysql_query("select * from sr_faq where status='1' AND faq_type_id=2 AND question LIKE '%".$query."%'");
}else{
	$query='';
	$sqlFaq=mysql_query("select * from sr_faq where status='1' AND faq_type_id=2");
}
