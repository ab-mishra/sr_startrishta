			...
			<div >
				...
				<div class="modal-body clearfix">
					<form class="login-form psnl_pro pull-left">
						...
						<div>
							<label><p>Date of birth:</p></label><input type="text" placeholder="" id="dob" class="input-group date" data-date-format="dd-mm-yyyy"/><p id="dob_div"></p>
						</div>
						<div>
						...
						<div class="relative">
							...
							<span class="ppd_srch"><i class="fa fa-search"></i></span>
						</div>
						<div class="relative">
										...
										?>
											<li class="p_location here_to_options" data-id="<?php echo $hereTo['here_to_id'];?>">
												<a href="javascript:void(0);">
													&nbsp; &#xf004; <span><?php echo $hereTo['here_to'];?></span>
												</a>
											</li>
										<?php } ?>
										<!--
...
<!--end-->
<?php } ?>
<!--Pop for Add Profile Photo-
<div id="myModal2" class="modal fade login_pop" role="dialog" >
	<div class="modal-dialog home_pg">
		<div class="modal-content">
			<div>
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Finally, add your photo</h4>
				</div>
				<div class="modal-body">
					<form class="login-form" method="POST" enctype="multipart/form-data">
						...
						<div class="popup_add_photo">
							<img src="images/dammy-profile-popup.png"/>
						</div>
						<!--<div class="popup_add_photo margin-t20">
							<input type="file" name="profile_image" id="profile_image" />
							<a class="btn btn-default default slat-blue" href="javascript:void(0);">Upload Photo </a>
						</div>-
...
<!--Pop for Add Photo on click of  photos-->
